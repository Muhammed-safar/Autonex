...
const articles = [
  {
    ...
    author: "Sinan",
    date: "20 May 2025",
    image: "https://res.cloudinary.com/p61kdb2x/image/upload/v1785223498/Buying_cheap_used_transmissions_isn_t_as_risky_as_you_think_pom1yu.jpg",
  ...
  },
  {
    ...
    author: "Sinan",
    date: "20 May 2025",
    image: "https://res.cloudinary.com/p61kdb2x/image/upload/v1785223498/What_to_Do_When_Your_Car_Parts_Start_Wearing_Out_ju8xu5.jpg",
  ...
  },
  {
    ...
    author: "Sinan",
    date: "20 May 2025",
    image: "https://res.cloudinary.com/p61kdb2x/image/upload/v1785223497/304_aoit7a.jpg",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        {articles.map((article) => (
          <article key={article.id} className="group flex flex-col cursor-pointer">
            ...
            <div className="relative aspect-[16/10] w-full overflow-hidden rounded-lg bg-slate-100 mb-4">
              <img
                src={article.image}
                alt={article.alt}
